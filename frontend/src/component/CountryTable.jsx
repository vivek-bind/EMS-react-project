...
class CountryTable extends Component {
  ...
  loadCountryData = () => {
    axios
      ...
      .then(response => {
        ...
        //   let temp = {
        //     data,
        //     CountryName: data?.CountryName || "Unknown Country", // ✅ Added optional chaining & default value
        //   };
        ...
        console.log("Processed rowDataT:", this.rowDataT);
      })
      .catch(error => {
        console.log(error);
      });
  ...
  handleAddCountry = (newCountry) => {
    axios
      .post("http://localhost:4000/api/country", newCountry, {
        headers: {
          authorization: localStorage.getItem("token") || "",
        },
      })
      .then((response) => {
        ...
        this.loadCountryData(); // Call the method to refresh data
      })
      .catch((error) => {
