...
class LeaveApplicationHRTable extends Component {
    ...
    axios
      ...
      .then(response => {
        ...
        (this.leaveApplicationHRObj || []).forEach(data => {
          let employee = (data["employee"] && data["employee"][0]) || {};
          
          let temp = {
            data,
            EmployeeCode: employee["EmployeeCode"] || "N/A",
            Name: (employee["FirstName"] || "Unknown") + " " + (employee["LastName"] || ""),
            Leavetype: data["Leavetype"] || "N/A",
            FromDate: data["FromDate"]?.slice(0, 10) || "N/A",
            ToDate: data["ToDate"]?.slice(0, 10) || "N/A",
            Reasonforleave: data["Reasonforleave"] || "N/A",
            //Status: this.status(data["Status"]) || "Unknown"
            Status: this.status(Number(data["Status"])) || "Unknown"
          };
  ...
  componentDidMount() {
    //this._isMounted = true; //new added code
